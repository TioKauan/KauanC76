...
export const mostrarPrecos = true;
...
// Itens comuns a todos os planos (texto do documento).
export const incluso = [
  'Câmeras 2 MP ou superior',
  'Gravação local por aproximadamente 10 dias',
  'Imagens pelo celular',
  'Instalação padrão e configuração',
  'Suporte e manutenção de defeitos naturais',
];
...
export function textoPreco(plano) {
...
export function mensagemPlano(plano) {
